...
require (
	...
	github.com/nickwells/col.mod/v2 v2.0.0-rc.1
	github.com/nickwells/filecheck.mod v1.0.6
	github.com/nickwells/location.mod v1.2.1
	github.com/nickwells/param.mod/v2 v2.3.0
	github.com/nickwells/param.mod/v3 v3.0.0-rc.2
	github.com/nickwells/twrap.mod v1.1.1
